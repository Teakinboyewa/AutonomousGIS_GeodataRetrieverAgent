...
class AGGRADockWidget(QtWidgets.QDockWidget, FORM_CLASS):
    ...
    def setup_initial_rows(self, keys_directory=keys_dir):
        ...
        # Parse datasource names from Handbooks directory
        handbooks_datasources = self.parse_handbooks_datasources()
        
        # Combine both keys and handbooks datasources, avoiding duplicates
        all_datasources = set(initial_keys + handbooks_datasources)
        
        # Add a row for each datasource found
